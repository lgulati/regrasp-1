//TODO: Send your server a message during loading (errors for calibration). When you're not checking for errors, look for scores. Update the logic. Give the ipad my ip address and port number
window.onload=function(){
    ...
    function setUpTimeOut(){
        ...
        if(notChecked){
            ...
            //If it has timed out three times
            if(attempt==3){
                attempt=0;
                notChecked=false;
    ...
    //THIS IS WHERE MESSAGES ARE SENT. COMMUNICATION WITH THE SERVER
    socket.on('message',function(data){
              ...
              diagramLayout=true;
              showDiagram();
              document.getElementById("objectsUsed").style.visibility="visible"; //NOT IMPORTANT
              document.getElementById("start").style.display="";
